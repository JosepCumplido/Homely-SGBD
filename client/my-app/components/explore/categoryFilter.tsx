...
export function CategoryFilter({categories, selectedCategory, onCategoryChange}: {
    ...
    return (
        <div className={"shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] pt-4 z-10 sticky top-0 flex flex-row gap-8 items-center bg-white w-full overflow-x-scroll no-scrollbar lg:justify-center"}>
            {categories.map((value, index) => (
                <div
                    ...
                    className={clsx(
                        ...
                        "flex flex-col gap-2 items-center justify-center border-b-2 border-transparent pb-3 cursor-pointer"
                    )}
                >
                    {value.icon}
                    <div
